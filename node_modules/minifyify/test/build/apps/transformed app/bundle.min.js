...
var tmpl=require("./template.hbs"),rendered=document.createElement("p");rendered.innerHTML=tmpl({message:"HBS Template Worked"}),document.body.appendChild(rendered);
},{"./template.hbs":10}],10:[function(require,module,exports){
var HandlebarsCompiler=require("hbsfy/runtime");module.exports=HandlebarsCompiler.template({compiler:[6,">= 2.0.0-beta.1"],main:function(e,a,s,l){var n;return"Handlebars "+this.escapeExpression((n=null!=(n=a.message||(null!=e?e.message:e))?n:a.helperMissing,"function"==typeof n?n.call(e,{name:"message",hash:{},data:l}):n))+" Template!\n"},useData:!0});
},{"hbsfy/runtime":8}]},{},[9])
