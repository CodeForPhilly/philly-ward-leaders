        ...
        <div class="hero-body">
          <div class="feedback">
            ...
            <form v-if="!submitted">
              ...
              <div
                class="form-text"
                v-if="formData.selectedOption === 'what-other'"
              >
              ...
              <br />
              <div class="form-text">
                <label for="tellUsAboutIt"
                  >Tell us about it
                  <span aria-label="Required question">*</span></label
                >
                <textarea
                  name="tellUsAboutIt"
                  id="tellUsAboutIt"
                  v-model="formData.tellUsAboutIt"
                  cols="40"
                  rows="4"
                  required
                ></textarea>
              ...
              <div class="form-text">
                <label for="thePageWhereItHappened"
                  >The page where it happened</label
                >
                <input
                  type="text"
                  id="thePageWhereItHappened"
                  name="thePageWhereItHappened"
...
export default {
  ...
  data() {
    return {
      ...
      radioList: [
        ...
        {
          id: "what-nice",
          label: "Nothing, I just want to say something nice",
        },
  ...
  computed: {
    formParams() {
      const selectedRadio = this.radioList.find(
        (radio) => radio.id === this.formData.selectedOption,
      );
      const params = {
        submit: "Submit",
